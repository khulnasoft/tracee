...
!!! Examples Note
    Below is an example of how to create a signature for the `net_packet_dns` event. This same example is used by Tracee CI/CD tests and can be found at the [GitHub repository](https://github.com/khulnasoft/tracee/tree/main/tests/e2e-net-signatures), together with some other signatures for the network events.
...
import (
    ...
    "github.com/khulnasoft/tracee/signatures/helpers"
    "github.com/khulnasoft/tracee/types/detect"
    "github.com/khulnasoft/tracee/types/protocol"
